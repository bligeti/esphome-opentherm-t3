...
OpenthermHub::OpenthermHub() : Component(), in_pin_{}, out_pin_{}, boot_pin_{}, reset_pin_{} {}
...
void OpenthermHub::setup() {
  ...
  this->opentherm_ = make_unique<OpenTherm>(this->in_pin_, this->out_pin_, this->boot_pin_, this->reset_pin_);
...
void OpenthermHub::handle_protocol_error_() {
  ESP_LOGW(TAG, "Protocol error occured while receiving response");
  this->stop_opentherm_();
}
